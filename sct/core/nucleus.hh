...
namespace sct {
  ...
  private:
    ...
    // generates one random nucleon and rotates it wrt the nucleus orientation, if applicable
    ...
    // functions to generate a random nucleon position, and to generate a smearing factor
    TVector3 generateNucleonPosition();
    TVector3 smear();
    
    vector<Nucleon> nucleons_; // container for nucleons
