...
double Random::uniform() { return unit_uniform_(generator_); }

double Random::uniform2() { return two_unit_uniform_(generator_); }

double Random::centeredUniform() {
  return two_unit_centered_uniform_(generator_);
}

double Random::zeroToPi() { return zero_to_pi_(generator_); }

double Random::linear() { return unit_linear_(generator_); }
