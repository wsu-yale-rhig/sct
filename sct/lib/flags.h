...
#define SCT_DECLARE_int(name)                    \
  SCT_GFLAGS_DECLARE(int32, name)
#define SCT_DECLARE_int64(name)                  \
  SCT_GFLAGS_DECLARE(int64, name)
#define SCT_DECLARE_double(name)                 \
  SCT_GFLAGS_DECLARE(double, name)
#define SCT_DECLARE_bool(name)                   \
  SCT_GFLAGS_DECLARE(bool, name)
#define SCT_DECLARE_string(name)                 \
