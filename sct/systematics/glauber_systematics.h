...
class GlauberSystematics {
 public:
  ...
  // variation. Looks for a variation named "nominal" when running, will error
  // out otherwise
 ...
 private:
  ...
  SystematicVariable rp_ecc_;            // npart weighted second order reaction
                                         // plane eccentricity
  SystematicVariable rp_ecc_mult_;       // multiplicity weighted second order
                                         // reaction plane eccentricity
  std::array<SystematicVariable, 3>
      pp_ecc_;  // npart weighted [second,third,fourth] order participant plane
                // eccentricity
