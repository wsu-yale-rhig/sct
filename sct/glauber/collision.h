...
class Collision {
 public:
  ...
  //       if the two nucleons are less than a distance R =
  //       sqrt(NNCrossSection/pi) a collision occurs
  ...
  inline void setCollisionProfile(CollisionProfile profile) {
    profile_ = profile;
  }
