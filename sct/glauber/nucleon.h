...
public:
  ...
  inline double x3() const {
    return position_.X() * position_.X() * position_.X();
  }
  inline double y3() const {
    return position_.Y() * position_.Y() * position_.Y();
  }
  inline double z3() const {
    return position_.Z() * position_.Z() * position_.Z();
  }
  inline double x2y() const {
    return position_.X() * position_.X() * position_.Y();
  }
  inline double xy2() const {
    return position_.X() * position_.Y() * position_.Y();
  }
  inline double y2z() const {
    return position_.Y() * position_.Y() * position_.Z();
  }
  inline double yz2() const {
    return position_.Y() * position_.Z() * position_.Z();
  }
  inline double z2x() const {
    return position_.Z() * position_.Z() * position_.X();
  }
  inline double zx2() const {
    return position_.Z() * position_.X() * position_.X();
  }
