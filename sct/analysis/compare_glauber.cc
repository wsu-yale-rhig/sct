...
// program settings
SCT_DEFINE_string(outDir, "tmp", "Path to directory to store output files");
...
int main(int argc, char* argv[]) {
  constexpr unsigned npart_idx =
      static_cast<unsigned>(sct::GlauberWeight::NPart);
  constexpr unsigned ncoll_idx =
      static_cast<unsigned>(sct::GlauberWeight::NColl);
  constexpr unsigned spec_idx =
      static_cast<unsigned>(sct::GlauberWeight::Spectators);
  ...
  TH2D* h_new_npnc =
      new TH2D("new_npartncoll", ";npart;ncoll", 100, 0, 400, 100, 0, 1500);
  TH1D* h_new_nspec = new TH1D("new_nspec", ";nspec", 100, 0, 400);
  TH2D* h_new_bnpart =
      new TH2D("new_bnpart", ";b[fm];npart", 100, 0, 20, 100, 0, 400);
  TH2D* h_new_bncoll =
      new TH2D("new_bncoll", ";b[fm];ncoll", 100, 0, 20, 100, 0, 1500);
  TH2D* h_old_npnc =
      new TH2D("old_npartncoll", ";npart;ncoll", 100, 0, 400, 100, 0, 1500);
  TH2D* h_old_bnpart =
      new TH2D("old_bnpart", ";b[fm];npart", 100, 0, 20, 100, 0, 400);
  TH2D* h_old_bncoll =
      new TH2D("old_bncoll", ";b[fm];ncoll", 100, 0, 20, 100, 0, 1500);
  ...
  TH2D* h_new_part_avg_xy_2D =
      new TH2D("new_part_avgxy2D", "", 100, -10, 10, 100, -10, 10);
  ...
  TH2D* h_new_coll_avg_xy_2D =
      new TH2D("new_coll_avgxy2D", "", 100, -10, 10, 100, -10, 10);
  ...
  TH2D* h_new_spec_avg_xy_2D =
      new TH2D("new_spec_avgxy2D", "", 100, -10, 10, 100, -10, 10);
  ...
  TH2D* h_old_part_avg_xy_2D =
      new TH2D("old_part_avgxy2D", "", 100, -10, 10, 100, -10, 10);
  ...
  TH2D* h_old_coll_avg_xy_2D =
      new TH2D("old_coll_avgxy2D", "", 100, -10, 10, 100, -10, 10);
  ...
  TH2D* h_old_spec_avg_xy_2D =
      new TH2D("old_spec_avgxy2D", "", 100, -10, 10, 100, -10, 10);

  // reaction plane eccentricity
  TH1D* h_new_part_rpecc2 =
      new TH1D("new_part_rpecc2", ";eccentricity", 100, 0, 1);
  TH1D* h_new_coll_rpecc2 =
      new TH1D("new_coll_rpecc2", ";eccentricity", 100, 0, 1);
  TH1D* h_new_spec_rpecc2 =
      new TH1D("new_spec_rpecc2", ";eccentricity", 100, 0, 1);
  TH1D* h_old_part_rpecc2 =
      new TH1D("old_part_rpecc2", ";eccentricity", 100, 0, 1);
  TH1D* h_old_coll_rpecc2 =
      new TH1D("old_coll_rpecc2", ";eccentricity", 100, 0, 1);
  TH1D* h_old_spec_rpecc2 =
      new TH1D("old_spec_rpecc2", ";eccentricity", 100, 0, 1);

  // participant plane
  TH1D* h_new_part_pp2 =
      new TH1D("new_part_pp2", ";pp2", 100, -sct::pi, sct::pi);
  TH1D* h_new_part_pp3 =
      new TH1D("new_part_pp3", ";pp3", 100, -sct::pi, sct::pi);
  TH1D* h_new_part_pp4 =
      new TH1D("new_part_pp4", ";pp4", 100, -sct::pi, sct::pi);
  TH1D* h_new_coll_pp2 =
      new TH1D("new_coll_pp2", ";pp2", 100, -sct::pi, sct::pi);
  TH1D* h_new_coll_pp3 =
      new TH1D("new_coll_pp3", ";pp3", 100, -sct::pi, sct::pi);
  TH1D* h_new_coll_pp4 =
      new TH1D("new_coll_pp4", ";pp4", 100, -sct::pi, sct::pi);
  TH1D* h_new_spec_pp2 =
      new TH1D("new_spec_pp2", ";pp2", 100, -sct::pi, sct::pi);
  TH1D* h_new_spec_pp3 =
      new TH1D("new_spec_pp3", ";pp3", 100, -sct::pi, sct::pi);
  TH1D* h_new_spec_pp4 =
      new TH1D("new_spec_pp4", ";pp4", 100, -sct::pi, sct::pi);

  TH1D* h_old_part_pp2 =
      new TH1D("old_part_pp2", ";pp2", 100, -sct::pi, sct::pi);
  TH1D* h_old_part_pp3 =
      new TH1D("old_part_pp3", ";pp3", 100, -sct::pi, sct::pi);
  TH1D* h_old_part_pp4 =
      new TH1D("old_part_pp4", ";pp4", 100, -sct::pi, sct::pi);
  TH1D* h_old_coll_pp2 =
      new TH1D("old_coll_pp2", ";pp2", 100, -sct::pi, sct::pi);
  TH1D* h_old_coll_pp3 =
      new TH1D("old_coll_pp3", ";pp3", 100, -sct::pi, sct::pi);
  TH1D* h_old_coll_pp4 =
      new TH1D("old_coll_pp4", ";pp4", 100, -sct::pi, sct::pi);
  TH1D* h_old_spec_pp2 =
      new TH1D("old_spec_pp2", ";pp2", 100, -sct::pi, sct::pi);
  TH1D* h_old_spec_pp3 =
      new TH1D("old_spec_pp3", ";pp3", 100, -sct::pi, sct::pi);
  TH1D* h_old_spec_pp4 =
      new TH1D("old_spec_pp4", ";pp4", 100, -sct::pi, sct::pi);
  ...
  while (new_reader.Next()) {
    ...
    if (new_eccpp2[npart_idx] == 1.0 || new_eccpp3[npart_idx] == 1.0) continue;
  ...
  sct::PrintWithRatio(h_new_part_avg_x, h_old_part_avg_x, "New Glauber library",
                      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "partavgx"), "", "<x>",
                      "fraction", "participant <x>");
  sct::PrintWithRatio(h_new_coll_avg_x, h_old_coll_avg_x, "New Glauber library",
                      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "collavgx"), "", "<x>",
                      "fraction", "binary collision <x>");
  sct::PrintWithRatio(h_new_spec_avg_x, h_old_spec_avg_x, "New Glauber library",
                      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "specavgx"), "", "<x>",
                      "fraction", "spectator <x>");

  // average y
  sct::PrintWithRatio(h_new_part_avg_y, h_old_part_avg_y, "New Glauber library",
                      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "partavgy"), "", "<y>",
                      "fraction", "participant <y>");
  sct::PrintWithRatio(h_new_coll_avg_y, h_old_coll_avg_y, "New Glauber library",
                      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "collavgy"), "", "<y>",
                      "fraction", "binary collision <y>");
  sct::PrintWithRatio(h_new_spec_avg_y, h_old_spec_avg_y, "New Glauber library",
                      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "specavgy"), "", "<y>",
                      "fraction", "spectator <y>");

  // average x^2
  sct::PrintWithRatio(h_new_part_avg_x2, h_old_part_avg_x2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "partavgx2"), "",
                      "<|x|>", "fraction", "participant <|x|>");
  sct::PrintWithRatio(h_new_coll_avg_x2, h_old_coll_avg_x2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "collavgx2"), "",
                      "<|x|>", "fraction", "binary collision <|x|>");
  sct::PrintWithRatio(h_new_spec_avg_x2, h_old_spec_avg_x2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
  ...
  // average y^2
  sct::PrintWithRatio(h_new_part_avg_y2, h_old_part_avg_y2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "partavgy2"), "",
                      "<|y|>", "fraction", "participant <|y|>");
  sct::PrintWithRatio(h_new_coll_avg_y2, h_old_coll_avg_y2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "collavgy2"), "",
                      "<|y|>", "fraction", "binary collision <|y|>");
  sct::PrintWithRatio(h_new_spec_avg_y2, h_old_spec_avg_y2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
  ...
  // average xy
  sct::PrintWithRatio(h_new_part_avg_xy, h_old_part_avg_xy,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "partavgxy"), "", "<xy>",
                      "fraction", "participant <xy>");
  sct::PrintWithRatio(h_new_coll_avg_xy, h_old_coll_avg_xy,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "collavgxy"), "", "<xy>",
                      "fraction", "binary collision <xy>");
  sct::PrintWithRatio(h_new_spec_avg_xy, h_old_spec_avg_xy,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "specavgxy"), "", "<xy>",
                      "fraction", "spectator <xy>");

  // reaction plane eccentricity
  sct::PrintWithRatio(h_new_part_rpecc2, h_old_part_rpecc2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
                      sct::MakeString(FLAGS_outPrefix, "partrpecc2"), "",
                      "#epsilon_{RP}", "fraction", "participant #epsilon_{RP}");
  sct::PrintWithRatio(
      h_new_coll_rpecc2, h_old_coll_rpecc2, "New Glauber library",
      "StFastGlauberMC", hOpts, cOpts, FLAGS_outDir,
      sct::MakeString(FLAGS_outPrefix, "collrpecc2"), "", "#epsilon_{RP}",
      "fraction", "binary collision #epsilon_{RP}");
  sct::PrintWithRatio(h_new_spec_rpecc2, h_old_spec_rpecc2,
                      "New Glauber library", "StFastGlauberMC", hOpts, cOpts,
                      FLAGS_outDir,
  ...
  sct::PrintWithRatio(
      h_new_coll_pp2, h_old_coll_pp2, "New Glauber library", "StFastGlauberMC",
      hOpts, cOpts, FLAGS_outDir, sct::MakeString(FLAGS_outPrefix, "collpp2"),
      "", "#Psi_{pp}^{2}", "fraction", "collision weighted participant plane");
  sct::PrintWithRatio(
      h_new_spec_pp2, h_old_spec_pp2, "New Glauber library", "StFastGlauberMC",
      hOpts, cOpts, FLAGS_outDir, sct::MakeString(FLAGS_outPrefix, "specpp2"),
  ...
  sct::PrintWithRatio(
      h_new_coll_pp3, h_old_coll_pp3, "New Glauber library", "StFastGlauberMC",
      hOpts, cOpts, FLAGS_outDir, sct::MakeString(FLAGS_outPrefix, "collpp3"),
      "", "#Psi_{pp}^{3}", "fraction", "collision weighted participant plane");
  sct::PrintWithRatio(
      h_new_spec_pp3, h_old_spec_pp3, "New Glauber library", "StFastGlauberMC",
      hOpts, cOpts, FLAGS_outDir, sct::MakeString(FLAGS_outPrefix, "specpp3"),
  ...
  sct::PrintWithRatio(
      h_new_coll_pp4, h_old_coll_pp4, "New Glauber library", "StFastGlauberMC",
      hOpts, cOpts, FLAGS_outDir, sct::MakeString(FLAGS_outPrefix, "collpp4"),
      "", "#Psi_{pp}^{4}", "fraction", "collision weighted participant plane");
  sct::PrintWithRatio(
      h_new_spec_pp4, h_old_spec_pp4, "New Glauber library", "StFastGlauberMC",
      hOpts, cOpts, FLAGS_outDir, sct::MakeString(FLAGS_outPrefix, "specpp4"),
      "", "#Psi_{pp}^{4}", "fraction", "spectator participant plane");

  // eccentricity
  sct::Overlay1D(h_new_part_ecc2, h_new_part_ecc3, "eccentricity",
                 "triangularity", hOpts, cOpts, FLAGS_outDir, "ppecc", "",
                 "participants", "<#epsilon_{n}>");
