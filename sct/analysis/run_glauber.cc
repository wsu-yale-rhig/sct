...
SCT_DEFINE_string(modification, "nominal",
                  "only applies when systematic = false. Can choose [nominal, large, small, largexsec, smallxsec, gaussian]")
...
void RunGlauber(sct::GlauberSpecies species, sct::CollisionEnergy energy,
  ...
  std::string outName = sct::MakeString(outDir, "/glauber_", modstring, "_",
                                 FLAGS_species, "_", FLAGS_energy, "gev_deformed_",
                                 (FLAGS_deformation ? "true" : "false"), ".root");
  // create output file
...
int main(int argc, char* argv[]) {
  ...
  std::vector<sct::GlauberMod> modifiers{sct::GlauberMod::Nominal,
    sct::GlauberMod::Large, sct::GlauberMod::Small, sct::GlauberMod::LargeXSec,
