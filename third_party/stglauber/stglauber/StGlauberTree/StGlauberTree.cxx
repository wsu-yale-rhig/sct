...
{
  switch ( mMode ){
    case 0: std::cout  << "StGlauberTree  read  mode" << std::endl; break ;
    case 1: std::cout  << "StGlauberTree  write mode" << std::endl; break ;
    default:
...
Int_t StGlauberTree::Open(const TString filename)
{
  if(mMode==0){
    ...
    std::cout  << "StGlauberTree::Open  Open input ROOT file: " << mFile->GetName() << std::endl ;
    ...
    std::cout  << "StGlauberTree::Open  Open output ROOT file: " << mFile->GetName() << std::endl ;

    // Initialization of tree
    std::cout  << "StGlauberTree::Open  Init tree" << std::endl;
...
{
  std::cout  << "StGlauberTree::Close  close ROOT file : " << mFile->GetName() << std::endl ;
