...
{
  std::cout  << "StCentralityMaker  User needs to call Init(const Char_t* system) function to Initialize NBD (see below)" << std::endl;
  StCentrality::help();
}
...
void StCentralityMaker::Init(const Char_t* system)
{
  ...
  std::cout  << "StCentralityMaker::Init  Initialization for " << systemName.Data() << std::endl ;
